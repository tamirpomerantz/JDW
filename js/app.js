...
function onWindowResize() {
    ...
    if (!isMobile) {
        ...
        for (let i = 0; i < meshArr.length; i++) {
            ...
            // positions of wireframe points
            pointsArr[i].position.x = meshArr[i].positionAfterResize.x;
            pointsArr[i].position.y = meshArr[i].positionAfterResize.y;
